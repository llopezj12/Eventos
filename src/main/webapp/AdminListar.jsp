...
<%@page import="es.eventos.eventos.entity.Evento"%>
<%@page import="java.util.List"%>
<%@page import="es.eventos.eventos.entity.Usuario"%>
...
<html>
    ...
    %>
              ...
              <td><a href="/eliminarUsuario/<%= u.getIdUsuario() %>" >Eliminar</a></td>
              </tr>
              <% } %>
        </thead>
        </table>
        ...
        %>
              ...
              <td><a href="/editarEvento/<%= e.getIdEvento() %>" >Editar</a></td>
              <td><a href="/eliminarEvento/<%= e.getIdEvento() %>" >Eliminar</a></td>
              </tr>
              <% } %>            
              </thead>
        </table>
